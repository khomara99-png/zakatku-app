            ...
            <table className="w-full text-left text-xs md:text-sm">
              <thead className="bg-gray-100 text-gray-600">
                <tr>
                  ...
                  <th className="px-3 py-2 text-center">Uang</th>
                  <th className="px-3 py-2 text-center">Beras</th>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Contoh: Hasan Yatim"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  className={inputClass}
                  placeholder="Contoh: Jl. Dahlia No. 1"
                />
              </div>
              <div>
